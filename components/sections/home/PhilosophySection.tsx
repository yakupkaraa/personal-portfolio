...
const cards: PhilosophyCard[] = [
  {
    ...
    description:
      "I believe in building foundations that last. My approach centers on modular components and robust state management for seamless growth.",
  ...
  },
  {
    ...
    description:
      "Optimized for Core Web Vitals, ensuring every millisecond is accounted for through modern hydration and lazy-loading strategies.",
    colSpan: "",
  },
  {
    ...
    title: "Clean Code",
    description:
      "Self-documenting, type-safe development using TypeScript and industry-leading linting standards for maintainable codebases.",
    colSpan: "",
  },
];
  ...
  return (
    <section className="max-w-7xl mx-auto px-8 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cards.map(({ icon, title, description, colSpan }) => (
          <div
            key={title}
        ...
        <div className="md:col-span-2 p-1 rounded-xl bg-gradient-to-br from-primary/10 via-card to-secondary/10">
